    ...
    <html>
      <head>
        ...
        <style>
          ...
          .existing-user-box {
            background: linear-gradient(135deg, rgba(16, 185, 129, 0.1), rgba(59, 130, 196, 0.1));
        ...
        <div class="email-wrapper">
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="message">
                Great news! Since you're already an AI Rocket member, you're automatically entered into the $5M Moonshot Challenge. No invite code needed - just log in to your existing account on January 15, 2026 and you'll be part of the competition!
              </div>

              <div class="existing-user-box">
                <div class="existing-label">Your Status</div>
                <div class="existing-message">Automatically Enrolled</div>
                <div class="existing-detail">
                  Your existing AI Rocket account will be part of the challenge. Just log in as usual starting January 15, 2026.
                </div>
              ...
              <div class="timeline-section">
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-desc">Log in to your existing account - you're automatically in the challenge!</div>
                </div>
                <div class="timeline-item">
              ...
              <div class="important-box">
                <div class="message" style="margin-bottom: 0;">
                  <strong>You're all set!</strong> As an existing AI Rocket member, you have a head start. Use this time to make sure your data is connected and your team is ready to compete when the challenge begins!
                </div>
              </div>
