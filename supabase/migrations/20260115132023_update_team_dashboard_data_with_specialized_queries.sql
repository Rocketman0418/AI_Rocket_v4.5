/*
  # Update get_team_dashboard_data with Specialized Queries

  1. Changes
    - Add mission_values_context from specialized function
    - Add goals_context from specialized function
    - These provide better-organized, prioritized data for AI extraction

  2. Benefits
    - VTO documents are found and aggregated properly
    - Goal-related documents are prioritized
    - Meeting notes are included for status updates
    - AI gets cleaner, more relevant data
*/
