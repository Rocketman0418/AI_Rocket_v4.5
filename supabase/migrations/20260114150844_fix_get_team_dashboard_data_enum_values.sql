/*
  # Fix get_team_dashboard_data Enum Values

  1. Issue
    The function was using 'projects' which is not a valid doc_category enum value.
    Valid values are: strategy, financial, operational, people, customer, external, 
    reference, other, meetings, sales, industry, product, legal, marketing, support, operations

  2. Fix
    - Changed 'projects' to just use 'product' category
    - Removed invalid enum value from the query
*/
